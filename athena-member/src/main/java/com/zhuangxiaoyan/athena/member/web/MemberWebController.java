package com.zhuangxiaoyan.athena.member.web;

import com.alibaba.fastjson.JSON;
import com.zhuangxiaoyan.athena.member.fegin.OrderFeignService;
...
public class MemberWebController {
    ...
    public String memberOrderPage(@RequestParam(value = "pageNum", required = false, defaultValue = "0") Integer pageNum,
        ...
        //远程查询订单服务订单数据
        Result orderInfo = orderFeignService.listWithItem(page);
