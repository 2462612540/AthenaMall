...
import com.zhuangxiaoyan.athena.secondskill.feign.CouponFeignService;
import com.zhuangxiaoyan.athena.secondskill.feign.ProductFeignService;
...
import com.zhuangxiaoyan.athena.secondskill.vo.SeckillSessionWithSkusVo;
import com.zhuangxiaoyan.athena.secondskill.vo.SkuInfoVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void uploadSeckillSkuLatest3Days() {
        ...
        Result lates3DaySession = couponFeignService.getLates3DaySession();
        ...
        sessions.stream().forEach(session -> {
            ...
            session.getRelationSkus().stream().forEach(seckillSkuVo -> {
                ...
                if (!operations.hasKey(redisKey)) {
                    ...
                    Result info = productFeignService.getSkuInfo(skuId);
                    if (info.getCode() == 0) {
